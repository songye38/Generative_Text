...
cp5 = new ControlP5(this);
  ...
  Group g1 = cp5.addGroup("choose Font")
 ...
 l = cp5.addListBox("list")
  ...
  Group g2 = cp5.addGroup("choose Font Color")
                .setBackgroundColor(color(0, 64))
   ...
   cw = cp5.addColorWheel("c", 15,10,150)
           .moveTo(g2);
   // println(cp5.get(ColorWheel.class,"c").getRGB()); //이렇게 해서 내가 Gui에서 선택한 컬러값 가져오기 
  
  // group number 3, contains a bang and a slider
  Group g3 = cp5.addGroup("choose Font size")
                .setBackgroundColor(color(0, 64))
                .setBackgroundHeight(100)
                ;
  s = cp5.addSlider("font size")
         .setPosition(15,10)
         .setRange(5,50)
         .moveTo(g3);
